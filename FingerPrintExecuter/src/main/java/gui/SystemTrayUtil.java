    ...
    public static void initSystemTray(FingerprintSyncGUI fingerprintSyncGUI) {
        ...
        startItem.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                trayIcon.displayMessage("Fingerprint software", "Finger print server start success.. ", TrayIcon.MessageType.INFO);
            }
        });
        stopItem.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                trayIcon.displayMessage("Fingerprint software", "Fingerprint server stop success.. ", TrayIcon.MessageType.WARNING);
        ...
        loggerItem.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (!fingerprintSyncGUI.isVisible()) {
                    ...
                    trayIcon.displayMessage("Fingerprint software", "logger viewed.. ", TrayIcon.MessageType.INFO);
                } else {
                    trayIcon.displayMessage("Fingerprint software", "logger already exists.. ", TrayIcon.MessageType.WARNING);
                }
        ...
        exitItem.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (fingerprintSyncGUI.isVisible()) {
                    ...
                    trayIcon.displayMessage("Fingerprint software", "logger closed.. ", TrayIcon.MessageType.INFO);
                }else{
                    trayIcon.displayMessage("Fingerprint software", "logger already closed.. ", TrayIcon.MessageType.INFO);
                }
